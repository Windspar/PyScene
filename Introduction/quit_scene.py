...
class QuitScenery(Scenery):
    def __init__(self, parent):
        ...
        Text(self, 'Confirm Quit', grid.position(3,1), self.font.basic, 'mediumorchid',
    ...
    def blit(self, surface):
        ...
        pygame.draw.rect(surface, pygame.Color('mediumorchid2'), self._rect.inflate(-4,-4), 1)
        pygame.draw.rect(surface, pygame.Color('mediumorchid3'), self._rect.inflate(-8,-8), 1)
